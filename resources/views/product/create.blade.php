...
<input type="text" placeholder="Enter Product Price" name="price" class="w-full rounded-lg my-2" value="{{old('price')}}">
@error('price')
<p class="text-red-500 mt-2">{{$message}}</p>
@enderror
...
<input type="text" placeholder="Enter Product Stock" name="stock" class="w-full rounded-lg my-2" value="{{old('stock')}}">
@error('stock')
<p class="text-red-500 mt-2">{{$message}}</p>
@enderror
